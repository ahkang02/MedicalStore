...
{
    public partial class StaffMaintenance : System.Web.UI.Page
    {
        // Connection 1
        SqlConnection con;
        ...
        protected void btnSubmitEdit_Click(object sender, EventArgs e)
        {
            ...
            if (n > 0)
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(), "Success", "alert('Staff Info Updated Successfully.');", true);
            }
            else
            {
